...
<tr>
	...
	<td align="left"><xsl:value-of select="@Sent"/></td>
	<td align="left"><xsl:value-of select="@LastTime"/></td>
...
<tr>
	<td align="left"><xsl:value-of select="@URL"/></td>
	<td align="left"><xsl:value-of select="@Active"/></td>
	<td align="left"><xsl:value-of select="@Size"/></td>
	<td align="left"><xsl:value-of select="@NumSent"/></td>
	<td align="left"><xsl:value-of select="@LastSent"/></td>
	<td align="left"><xsl:value-of select="@LastQueued"/></td>
...
<xsl:template match="RemovedChannel">  
	<li>
	Subscription <xsl:value-of select="@ChannelID"/> to <xsl:value-of select="@URL"/> has been removed.
	</li>
</xsl:template>  
