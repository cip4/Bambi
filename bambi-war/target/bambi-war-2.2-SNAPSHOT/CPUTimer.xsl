...
<tr>
<td colspan="2" align="left">Start: <xsl:value-of select="@CreationTime"/></td>
<td align="left">Invocations: <xsl:value-of select="@StartStop"/></td>
</tr>
<tr>
<th>Current </th>
...
<tr>
<td align="left"><xsl:value-of select="@CurrentRealTime"/></td>
<td align="left"><xsl:value-of select="@TotalRealTime"/></td>
<td align="left"><xsl:value-of select="@AverageRealTime"/></td>
</tr>
<tr>
<td align="left"><xsl:value-of select="@CurrentCPUTime"/></td>
<td align="left"><xsl:value-of select="@TotalCPUTime"/></td>
<td align="left"><xsl:value-of select="@AverageCPUTime"/></td>
</tr>
</font>
</table>
